...
(cl:defmethod center_x-val ((m <BoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obstacle_detection-msg:center_x-val is deprecated.  Use obstacle_detection-msg:center_x instead.")
  (center_x m))

(cl:ensure-generic-function 'center_y-val :lambda-list '(m))
(cl:defmethod center_y-val ((m <BoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obstacle_detection-msg:center_y-val is deprecated.  Use obstacle_detection-msg:center_y instead.")
  (center_y m))

(cl:ensure-generic-function 'w-val :lambda-list '(m))
(cl:defmethod w-val ((m <BoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obstacle_detection-msg:w-val is deprecated.  Use obstacle_detection-msg:w instead.")
  (w m))

(cl:ensure-generic-function 'h-val :lambda-list '(m))
(cl:defmethod h-val ((m <BoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obstacle_detection-msg:h-val is deprecated.  Use obstacle_detection-msg:h instead.")
  (h m))

(cl:ensure-generic-function 'confidence-val :lambda-list '(m))
(cl:defmethod confidence-val ((m <BoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obstacle_detection-msg:confidence-val is deprecated.  Use obstacle_detection-msg:confidence instead.")
  (confidence m))

(cl:ensure-generic-function 'class_id-val :lambda-list '(m))
(cl:defmethod class_id-val ((m <BoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader obstacle_detection-msg:class_id-val is deprecated.  Use obstacle_detection-msg:class_id instead.")
  (class_id m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<BoundingBox>)))
  ...
  "585fb433a001f442e661e32eaeeb2b06")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'BoundingBox)))
  "Returns md5sum for a message object of type 'BoundingBox"
  "585fb433a001f442e661e32eaeeb2b06")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<BoundingBox>)))
  ...
  (cl:format cl:nil "float32 center_x~%float32 center_y~%float32 w~%float32 h~%float32 confidence~%float32 class_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'BoundingBox)))
  "Returns full string definition for message of type 'BoundingBox"
  (cl:format cl:nil "float32 center_x~%float32 center_y~%float32 w~%float32 h~%float32 confidence~%float32 class_id~%~%~%"))
